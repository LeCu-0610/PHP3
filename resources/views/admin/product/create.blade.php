        ...
        <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="price-input">
                                <input type="number" class="form-control" name="price" step="1000" value="{{ old('price') }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="price-input">
                                <input type="number" class="form-control" name="sale_price" step="1000" value="{{ old('sale_price', 0) }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                        ...
                        <div class="image-upload-container" onclick="document.getElementById('thumbnail').click()">
                            <div class="file-input-wrapper">
                                ...
                                <label for="thumbnail" class="file-input-label">
                                    <i class="fas fa-cloud-upload-alt me-2"></i>Chọn ảnh sản phẩm
                                </label>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div id="imagePreview" class="image-preview-container" style="display: none;">
                            <h6 class="text-muted mb-2"><i class="fas fa-eye me-2"></i>Xem trước ảnh</h6>
            ...
            <div class="form-section">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="description" rows="2" placeholder="Mô tả ngắn gọn về sản phẩm...">{{ old('description') }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="content" class="form-label">Nội dung chi tiết</label>
                    <textarea class="form-control" name="content" rows="3" placeholder="Mô tả chi tiết về sản phẩm...">{{ old('content') }}</textarea>
                </div>
            </div>

            <!-- Biến thể sản phẩm -->
            <div class="form-section">
                <h5><i class="fas fa-palette me-2"></i>Biến thể sản phẩm</h5>
                
                <div id="variants-container">
                    <div class="variant-item">
                        <div class="variant-header">
                            <h6 class="mb-0"><i class="fas fa-cube me-2"></i>Biến thể #1</h6>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                <label class="form-label">Màu sắc</label>
                                <input type="text" name="variants[0][color]" class="form-control" placeholder="VD: Đỏ, Xanh">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Kích thước</label>
                                <input type="text" name="variants[0][size]" class="form-control" placeholder="VD: S, M, L">
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" name="variants[0][price]" class="form-control" step="1000" placeholder="0">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">Giá sale</label>
                                <input type="number" name="variants[0][sale_price]" class="form-control" step="1000" placeholder="0">
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <label class="form-label">SKU</label>
                                <input type="text" name="variants[0][sku]" class="form-control" placeholder="Mã sản phẩm">
                            </div>
                            <div class="col-md-6">
                ...
                <button type="button" class="btn btn-add-variant" onclick="addVariant()">
...
<script>
    ...
    function addVariant() {
        ...
        newVariant.innerHTML = `
            <div class="variant-header">
                <h6 class="mb-0"><i class="fas fa-cube me-2"></i>Biến thể #${variantIndex + 1}</h6>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <label class="form-label">Kích thước</label>
                    <input type="text" name="variants[${variantIndex}][size]" class="form-control" placeholder="VD: S, M, L">
                </div>
                <div class="col-md-2">
                    <label class="form-label">Số lượng</label>
                ...
                <div class="col-md-2">
                    <label class="form-label">Giá</label>
                    <input type="number" name="variants[${variantIndex}][price]" class="form-control" step="1000" placeholder="0">
                </div>
                <div class="col-md-2">
                    <label class="form-label">Giá sale</label>
                    <input type="number" name="variants[${variantIndex}][sale_price]" class="form-control" step="1000" placeholder="0">
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-6">
                    <label class="form-label">SKU</label>
                    <input type="text" name="variants[${variantIndex}][sku]" class="form-control" placeholder="Mã sản phẩm">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Ảnh biến thể</label>
